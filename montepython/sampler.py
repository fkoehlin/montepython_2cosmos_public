...
def compute_lkl(cosmo1, cosmo2, data):
    ...
    if ((data.need_cosmo1_update) or
        ...
        if 'SZ' in data.cosmo1_arguments['output']:
            ...
            try:
                ...
                #print('cosmo params')
                #print(data.cosmo1_arguments)
                #print(data.cosmo1_arguments['tau_reio'])
                sys.stderr.write(str(failure_message)+'\n')
                sys.stderr.flush()
                return data.boundary_loglike
            except CosmoSevereError as critical_message:
    ...
    if ((data.need_cosmo2_update) or
        ...
        if 'SZ' in data.cosmo2_arguments['output']:
            ...
            try:
                ...
                #np.set_printoptions(precision=30, linewidth=150)
                #print('cosmo params')
                #print(data.cosmo2_arguments)
                #print(data.cosmo2_arguments['tau_reio'])
                sys.stderr.write(str(failure_message)+'\n')
                sys.stderr.flush()
                return data.boundary_loglike
            except CosmoSevereError as critical_message:
    ...
    if data.get_mcmc_parameters(['derived']) != []:
        ...
        # except AttributeError:
            ...
            # cosmo2.get_current_derived_parameters(data)
